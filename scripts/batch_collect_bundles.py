...
import pandas as pd
from brtxgnn.collectors import DrugBundleAggregator
from brtxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from brtxgnn.collectors.drug_bundle import PredictedIndication
    from brtxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from brtxgnn.collectors.drug_bundle import DrugBundle
