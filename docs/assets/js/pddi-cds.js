/**
 * BrTxGNN PDDI-CDS (Potential Drug-Drug Interaction Clinical Decision Support)
 *
...
(function(global) {
  ...
  function generateCDSHooksCard(pddi) {
    const card = {
      ...
      source: {
        label: 'BrTxGNN PDDI-CDS',
        url: 'https://brtxgnn.yao.care/smart/',
        icon: 'https://brtxgnn.yao.care/assets/img/icon-192.png'
      },
      ...
      links: [
        {
          label: '查看完整資訊',
          url: `https://brtxgnn.yao.care/drugs/`,
          type: 'absolute'
        }
      ],
      overrideReasons: [
